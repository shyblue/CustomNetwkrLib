...
#ifndef __PLAYERDETAILINFOLOAD_H_
#define __PLAYERDETAILINFOLOAD_H_
...
private :
    ...
    static size_t Deserialize(char* buffer, size_t buffer_size, uint64_t& leaguetime, int32_t& pitcher_path_length, std::string& pitcher_path, uint32_t& fielder_path_length, std::string& fielder_path);
};
