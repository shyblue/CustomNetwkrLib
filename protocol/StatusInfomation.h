...
#ifndef BUSINESS_PROTOCOL_STATUSINFOMATION_H_
#define BUSINESS_PROTOCOL_STATUSINFOMATION_H_
...
private :
    ...
    static size_t Unserialize(char* buffer, size_t buffer_size, int32_t& infomation_no);
};
