...
#ifndef __ANIMATIONINFOPASSING_H_
#define __ANIMATIONINFOPASSING_H_
...
private :
    ...
    static size_t Deserialize(char* buffer, size_t buffer_size, uint64_t& user_uid, uint64_t& leaguetime, uint32_t& league_no);
};
